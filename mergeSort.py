...
def merge(arr, l, mid, r):
    ...
    for i in range(l, r):
        ...
        if r_pointer == r_length:
            ...
            arr[i] = L[l_pointer]
            l_pointer += 1
        # if  r_pointer == sub_arr_length or l_pointer == sub_arr_length or L[l_pointer] < R[r_pointer]:
        #     arr[i] = L[l_pointer]
        #     l_pointer += 1
        #     print(f"left pointer after shifting: {l_pointer}")
        # elif l_pointer == sub_arr_length or r_pointer == sub_arr_length or L[l_pointer] > R[r_pointer]:
        #     arr[i] = R[r_pointer]
        #     r_pointer += 1
        #     print(f"right pointer after shifting: {r_pointer}")
